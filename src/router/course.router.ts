...
courseRouter.route('/').get(authComm.verifyToken, checkUserHandler([UserType.admin, UserType.manager]),endpointLogger.logger, courseController.CourseGet)

// Route to create a new course
// Requires token verification and validation
courseRouter.route('/').post(authComm.verifyToken, checkUserHandler([UserType.admin]), courseValid.post,endpointLogger.logger, courseController.CoursePost)
